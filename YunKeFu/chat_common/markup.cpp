// Markup.cpp: implementation of the CMarkupXml class.
//
// Markup Release 10.0
// Copyright (C) 2008 First Objective Software, Inc. All rights reserved
// Go to www.firstobject.com for the latest CMarkupXml and EDOM documentation
...
void CMarkupXml::operator=( const CMarkupXml& markup )
{
...
bool CMarkupXml::SetDoc( MCD_PCSZ pDoc )
{
	// Set document text
	if ( pDoc )
		m_strDoc = pDoc;
...
bool CMarkupXml::SetDoc( const MCD_STR& strDoc )
{
	m_strDoc = strDoc;
	MCD_STRCLEAR(m_strError);
	return x_ParseDoc();
...
bool CMarkupXml::Load( MCD_CSTR szFileName )
{
...
bool CMarkupXml::ReadTextFile( MCD_CSTR szFileName, MCD_STR& strDoc, MCD_STR* pstrError, int* pnDocFlags )
{
...
bool CMarkupXml::Save( MCD_CSTR szFileName )
{
	return WriteTextFile( szFileName, m_strDoc, &m_strError, &m_nDocFlags );
}

bool CMarkupXml::WriteTextFile( MCD_CSTR szFileName, MCD_STR& strDoc, MCD_STR* pstrError, int* pnDocFlags )
{
	...
	// Get document length
//	MCD_STR sss = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\r\n<root>";
//	sss += strDoc;
//	sss += "\r\n</root>";
//	strDoc = sss;
...
bool CMarkupXml::FindElem( MCD_CSTR szName )
{
...
bool CMarkupXml::FindChildElem( MCD_CSTR szName )
{
...
MCD_STR CMarkupXml::EscapeText( MCD_CSTR szText, int nFlags )
{
...
MCD_STR CMarkupXml::UnescapeText( MCD_CSTR szText, int nTextLength /*=-1*/ )
{
...
int CMarkupXml::x_WCToMB( int nCP, char* pszMB, int nMBCount, const wchar_t* pwszWide, int nWideLen, int* pnFailed/*=NULL*/ )
{
...
int CMarkupXml::UTF16To8( char* pszUTF8, const wchar_t* pwszUTF16, int nUTF8Count )
{
...
int CMarkupXml::DecodeCharUTF8( const char*& pszUTF8 )
{
...
void CMarkupXml::EncodeCharUTF16( int nUChar, wchar_t* pwszUTF16, int& nWideLen )
{
...
int CMarkupXml::x_MBToWC( int nCP, wchar_t* pwszWide, int nWideCount, const char* pszMB, int nMBLen )
{
#if defined(MARKUP_STDCONV)
...
int CMarkupXml::UTF8To16( wchar_t* pwszUTF16, const char* pszUTF8, int nUTF8Count )
{
...
int CMarkupXml::DecodeCharUTF16( const wchar_t*& pwszUTF16 )
{
...
void CMarkupXml::EncodeCharUTF8( int nUChar, char* pszUTF8, int& nUTF8Len )
{
...
MCD_STR CMarkupXml::UTF8ToA( MCD_CSTR pszUTF8, int* pnFailed/*=NULL*/ )
{
...
MCD_STR CMarkupXml::AToUTF8( MCD_CSTR pszANSI )
{
...
MCD_STR CMarkupXml::GetDeclaredEncoding( MCD_CSTR szDoc )
{
...
int CMarkupXml::FindNode( int nType )
{
...
MCD_STR CMarkupXml::GetTagName() const
{
...
MCD_STR CMarkupXml::GetAttribName( int n ) const
{
...
bool CMarkupXml::SavePos( MCD_CSTR szPosName /*=""*/, int nMap /*=0*/ )
{
...
bool CMarkupXml::RestorePos( MCD_CSTR szPosName /*=""*/, int nMap /*=0*/ )
{
...
bool CMarkupXml::SetMapSize( int nSize, int nMap /*=0*/ )
{
...
bool CMarkupXml::RemoveChildElem()
{
...
MCD_STR CMarkupXml::x_GetLastError()
{
...
bool CMarkupXml::x_AllocPosArray( int nNewSize /*=0*/ )
{
...
int CMarkupXml::x_ParseElem( int iPosParent, TokenPos& token )
{
...
bool CMarkupXml::x_FindAny( MCD_PCSZ pDoc, int& nChar )
{
...
bool CMarkupXml::x_FindName( CMarkupXml::TokenPos& token )
{
...
MCD_STR CMarkupXml::x_GetToken( const CMarkupXml::TokenPos& token )
{
...
int CMarkupXml::x_FindElem( int iPosParent, int iPos, MCD_PCSZ pPath ) const
{
...
int CMarkupXml::x_ParseNode( CMarkupXml::TokenPos& token, CMarkupXml::NodePos& node )
{
...
MCD_STR CMarkupXml::x_GetPath( int iPos ) const
{
	MCD_STR strPath;
	while ( iPos )
	{
...
MCD_STR CMarkupXml::x_GetTagName( int iPos ) const
{
...
bool CMarkupXml::x_FindAttrib( CMarkupXml::TokenPos& token, MCD_PCSZ pAttrib, int n/*=0*/ )
{
...
MCD_STR CMarkupXml::x_GetAttrib( int iPos, MCD_PCSZ pAttrib ) const
{
...
bool CMarkupXml::x_SetAttrib( int iPos, MCD_PCSZ pAttrib, int nValue, int nFlags /*=0*/ )
{
...
bool CMarkupXml::x_SetAttrib( int iPos, MCD_PCSZ pAttrib, MCD_PCSZ pValue, int nFlags /*=0*/ )
{
...
bool CMarkupXml::x_CreateNode( MCD_STR& strNode, int nNodeType, MCD_PCSZ pText )
{
...
MCD_STR CMarkupXml::x_EncodeCDATASection( MCD_PCSZ szData )
{
...
bool CMarkupXml::x_SetData( int iPos, int nValue )
{
	// Convert integer to string
	MCD_CHAR szVal[25];
	MCD_SPRINTF( MCD_SSZ(szVal), MCD_T("%d"), nValue );
...
bool CMarkupXml::x_SetData( int iPos, MCD_PCSZ szData, int nFlags )
{
...
MCD_STR CMarkupXml::x_GetData( int iPos ) const
{
	if ( iPos == m_iPos && m_nNodeLength )
	{
...
MCD_STR CMarkupXml::x_GetElemContent( int iPos ) const
{
...
bool CMarkupXml::x_SetElemContent( MCD_PCSZ szContent )
{
...
void CMarkupXml::x_DocChange( int nLeft, int nReplace, const MCD_STR& strInsert )
{
...
void CMarkupXml::x_Adjust( int iPos, int nShift, bool bAfterPos /*=false*/ )
{
...
int CMarkupXml::x_InsertNew( int iPosParent, int& iPosRel, CMarkupXml::NodePos& node )
{
...
bool CMarkupXml::x_AddElem( MCD_PCSZ pName, int nValue, int nFlags )
{
	// Convert integer to string
	MCD_CHAR szVal[25];
	MCD_SPRINTF( MCD_SSZ(szVal), MCD_T("%d"), nValue );
...
bool CMarkupXml::x_AddElem( MCD_PCSZ pName, MCD_PCSZ pValue, int nFlags )
{
	if ( nFlags & MNF_CHILD )
	{
...
MCD_STR CMarkupXml::x_GetSubDoc( int iPos ) const
{
	if ( iPos )
	{
...
bool CMarkupXml::x_AddSubDoc( MCD_PCSZ pSubDoc, int nFlags )
{
...
int CMarkupXml::x_RemoveElem( int iPos )
{
...
void CMarkupXml::x_LinkElem( int iPosParent, int iPosBefore, int iPos )
{
...
int CMarkupXml::x_UnlinkElem( int iPos )
{
...
int CMarkupXml::x_ReleasePos( int iPos )
{
...
int CMarkupXml::x_ReleaseSubDoc( int iPos )
{
...
bool CMarkupXml::x_GetMap( SavedPosMap*& pMap, int nMap, int nMapSize /*=7*/ )
{
...
void CMarkupXml::x_CheckSavedPos()
{
...
void CMarkupXml::x_AdjustForNode( int iPosParent, int iPos, int nShift )
{
...
bool CMarkupXml::x_AddNode( int nNodeType, MCD_PCSZ pText, int nNodeFlags )
{
...
void CMarkupXml::x_RemoveNode( int iPosParent, int& iPos, int& nNodeType, int& nNodeOffset, int& nNodeLength )
{
