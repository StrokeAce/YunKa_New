...
public:
	...
	static BYTE * JpegFileToRGB(string fileName,			// path to image
	...
	static BOOL RGBToJpegFile(string fileName,				// path
	...
	static BOOL GetJPGDimensions(string fileName,			// path
								UINT *width,				// pixels
								UINT *height);
