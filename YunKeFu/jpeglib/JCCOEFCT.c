...
METHODDEF(_int_boolean) compress_data
    JPP((j_compress_ptr cinfo, JSAMPIMAGE input_buf));
#ifdef FULL_COEF_BUFFER_SUPPORTED
METHODDEF(_int_boolean) compress_first_pass
    JPP((j_compress_ptr cinfo, JSAMPIMAGE input_buf));
METHODDEF(_int_boolean) compress_output
    JPP((j_compress_ptr cinfo, JSAMPIMAGE input_buf));
#endif
...
GLOBAL(void)
jinit_c_coef_controller (j_compress_ptr cinfo, _int_boolean need_full_buffer)
{
  my_coef_ptr coef;
