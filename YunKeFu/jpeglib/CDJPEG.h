...
EXTERN(_int_boolean) read_quant_tables JPP((j_compress_ptr cinfo, char * filename,
				    int scale_factor, _int_boolean force_baseline));
EXTERN(_int_boolean) read_scan_script JPP((j_compress_ptr cinfo, char * filename));
EXTERN(_int_boolean) set_quant_slots JPP((j_compress_ptr cinfo, char *arg));
EXTERN(_int_boolean) set_sample_factors JPP((j_compress_ptr cinfo, char *arg));
...
EXTERN(_int_boolean) keymatch JPP((char * arg, const char * keyword, int minchars));
