...
public:
    ...
    void RePaint() 
    {
        ...
        CRenderEngine::DrawImageString(hDcBackground, &m_pm, rcClient, rcClient, _T("file='menu\\right_menu_bk.png' corner='40,8,8,8'"), NULL);
...
class CMenuWnd2 : public CWindowWnd, public INotifyUI
{
public:
	CMenuWnd2() : m_pOwner(NULL), m_pShadowWnd(NULL) { };
    ...
    LPCTSTR GetWindowClassName() const { return _T("MenuWnd2"); };
    void OnFinalMessage(HWND /*hWnd*/) { delete this; };
