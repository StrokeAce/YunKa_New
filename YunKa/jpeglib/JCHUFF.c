...
METHODDEF(_int_boolean) encode_mcu_huff JPP((j_compress_ptr cinfo,
					JBLOCKROW *MCU_data));
METHODDEF(void) finish_pass_huff JPP((j_compress_ptr cinfo));
#ifdef ENTROPY_OPT_SUPPORTED
METHODDEF(_int_boolean) encode_mcu_gather JPP((j_compress_ptr cinfo,
					  JBLOCKROW *MCU_data));
...
METHODDEF(void)
start_pass_huff (j_compress_ptr cinfo, _int_boolean gather_statistics)
{
...
finish_pass_gather (j_compress_ptr cinfo)
{
  ...
  jpeg_component_info * compptr;
  JHUFF_TBL **htblptr;
  _int_boolean did_dc[NUM_HUFF_TBLS];
  _int_boolean did_ac[NUM_HUFF_TBLS];
