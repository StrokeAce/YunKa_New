...
typedef struct {		/* Bitreading state saved across MCUs */
  ...
  _int_boolean printed_eod;		/* flag to suppress multiple warning msgs */
} bitread_perm_state;
...
typedef struct {		/* Bitreading working state within an MCU */
  ...
  _int_boolean * printed_eod_ptr;	/* => flag in permanent state */
...
EXTERN(_int_boolean) jpeg_fill_bit_buffer
