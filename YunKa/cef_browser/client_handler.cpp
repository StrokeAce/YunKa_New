...
#include "cef_browser/binding_test.h"
#include "cef_browser/cefclient.h"
#include "cef_browser/client_renderer.h"
#include "cef_browser/client_switches.h"
#include "cef_browser/dialog_test.h"
    ...
    focus_on_editable_field_(false) 
{
  ...
  m_hWnd = NULL;
  m_handlerName = "unused";
  m_isDisplayCopy = true;
  m_isDisplayRefresh = true;
...
void ClientHandler::LoadString(string html)
{
	if (browser_ != NULL)
	{
		browser_->GetMainFrame()->LoadString(html, "about:blank");
	}
}
